    ...
    return (
        <View style={tailwind`flex-1 bg-black bg-opacity-40`}>
            ...
            <View style={tailwind`pb-5  w-full px-4 bg-white pt-4`}>
                <Text style={tailwind`text-black text-center text-xl font-bold mb-5`}>Detalles de pedido</Text>
                <View style={tailwind`mb-5`}>
                    ...
                    <OrderItem name="Total de pedido" value={`$${totalPrice}0`} total />
                </View>
                <TouchableOpacity style={tailwind`py-3 px-10 self-center bg-black rounded-full`} onPress={addOrder}>
                    <Text style={tailwind`text-white`}>Pagar</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
