        ...
        <Screen style={tailwind`flex-1 bg-white`}>
            <ScrollView style={tailwind`flex-1`} showsVerticalScrollIndicator={false}>
                <View style={tailwind`mt-2 mx-4 mb-1 relative justify-center`}>
                    ...
                    <TextInput style={[tailwind`rounded-full py-2 px-5 pl-10 bg-gray-100`, styles.input]} placeholder="Buscar comidas top ..." />
                </View>
                <Text style={tailwind`text-lg mt-2 ml-4`}>Comidas Top</Text>
