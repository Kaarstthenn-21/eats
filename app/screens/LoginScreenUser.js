...
const loginValidationSchema = yup.object().shape({
  ...
  password: yup
    .string()
    .min(8, ({ min }) => `Password debe ser mayor de ${min} caracteres`)
    ...
    auth
      ...
      .catch((error) => {
        if (error.code === "auth/invalid-password") {
          Alert.alert("Error", "Password invalido!")
        }
    ...
    <Screen style={styles.container}>
      <View style={styles.wrapper}>
        ...
        <Text style={styles.wellcomeTo}>
          Login para SR <Text style={styles.brand}>Eats</Text>
        </Text>
        <View style={styles.form}>
          ...
          >
            <AppFormFeilds
              name="email"
              placeholder="kaarstthen.ancco@tecsup.edu.pe"
